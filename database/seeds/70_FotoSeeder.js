...
class FotoSeeder {
  async run () {
    await Foto.createMany([
      ...
      {id: '4', mapa_id: '4', foto: 'https://liquipedia.net/commons/images/2/2b/De_new_inferno.jpg'},
      ...
      {id: '8', mapa_id: '8', foto: 'https://static.wikia.nocookie.net/cswikia/images/4/4a/De_train_thumbnail.png/revision/latest/scale-to-width-down/1000?cb=20181004200630'},
